...
n = NeuralNetMLP(2, training_data.shape[1], n_hidden=30,
                 l1=0.0, l2=0.0, epochs=500, eta=0.001,
                 alpha=0.0, decrease_const=0.0, shuffle=True,
                 minibatches=1, random_state=None)
print(n.w1)
...
n.fit(training_data, training_ouput, True)
print(n.w1)
print(n.w2)

print(testing_data.size)
print(testing_data)
predictions = n.predict(testing_data)
wrong = 0
for i in range(0,len(predictions)):
    print(testing_info[i])
    print("Predicted Ouctome")
    print(predictions[i])
    #print("Expected Ouctome")
    #print(testing_output[i])
    #if(predictions[i] != testing_output[i]):
     #   wrong = wrong + 1
