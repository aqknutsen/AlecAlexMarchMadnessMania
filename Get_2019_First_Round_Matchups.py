...
class GET2019OPPONENTS:
    create_table_queries = ['''create table THISYEARSGAMES
                                   (YEAR integer, Team1 text, Team2 text,Seed1 integer, Seed2 integer)''']
    insert_queries = ['insert into THISYEARSGAMES values (?,?,?,?,?)']
    ...
    def find_opponents(self):
        ...
        c = conn.cursor()
        c.execute('''DROP TABLE THISYEARSGAMES''')
        ...
        for year in range(2018,2019):
            ...
            try:
                ...
                while td_index < len(td_list)-1:
                    try:
                        temp1 = re.sub("\D", "", seeds_list[seed_index].get_text())
                        temp2 = re.sub("\D", "", seeds_list[seed_index+1].get_text())

                        teamname1 = td_list[td_index].get_text()
                        teamname2 = td_list[td_index+1].get_text()
                        ...
                        if teamname1 == "St. Joseph's":
                            teamname1 = teamname1.replace('St.', 'Saint')
                        if teamname1 == "Portland State" or teamname1 =="Morehead State":
                        ...
                        if teamname1 == "Connecticut":
                            teamname1 = teamname2.replace('Connecticut', 'UConn')
                        if teamname1 == "Loyola-Chicago":
                            teamname1 = teamname2.replace('Loyola-Chicago', 'Loyola (Chi)')
                        ...
                        if teamname2 == "St. Joseph's":
                            teamname2 = teamname2.replace('St.', 'Saint')
                        if teamname2 == "Portland State" or teamname2 == "Morehead State":
                        ...
                        if "/" in teamname2:
                            if teamname2.split("/")[0] == "NCCU":
                                data = (year, teamname1,"North Carolina Central", temp1, temp2)
                                print(data)
                                c.execute(self.insert_queries[0], data)
                                conn.commit()
                                data = (year, teamname1, "Texas Southern", temp1, temp2)
                                print(data)
                                c.execute(self.insert_queries[0], data)
                                conn.commit()
                                td_index += 2
                                seed_index += 2
                                continue
                            elif teamname2.split("/")[0] == "LIU":
                                data = (year, teamname1, "LIU Brooklyn", temp1, temp2)
                                print(data)
                                c.execute(self.insert_queries[0], data)
                                conn.commit()
                                data = (year, teamname1, "Radford", temp1, temp2)
                                print(data)
                                c.execute(self.insert_queries[0], data)
                                conn.commit()
                                td_index += 2
                                ...
                                data = (year, teamname1, teamname2.split("/")[0], temp1, temp2)
                                print(data)
                                c.execute(self.insert_queries[0], data)
                                conn.commit()
                                data = (year, teamname1, teamname2.split("/")[1], temp1, temp2)
                                print(data)
                                c.execute(self.insert_queries[0], data)
                                conn.commit()
                                td_index += 2
                            ...
                            data = (year, teamname1,teamname2,temp1,temp2)
                            print(data)
                            c.execute(self.insert_queries[0], data)
                            conn.commit()
                            td_index += 2
